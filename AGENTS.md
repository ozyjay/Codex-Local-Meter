...
- `images/codex-local-meter.woff` — generated by `scripts/RebuildVsix.ps1` from `icon-mono.svg` via `svgtofont`. Do not hand-edit or commit. The tool is non-deterministic: the binary changes on every run even with identical input.
- `images/icon.png` — generated by `scripts/RebuildVsix.ps1` from `icon.svg` via `npx @resvg/resvg-js-cli images/icon.svg images/icon.png`. Do not hand-edit or commit.
